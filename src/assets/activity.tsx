const Activity = ()=>{
    return(
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M4.88666 9.66003L6.47332 7.60003C6.69999 7.30669 7.11999 7.25336 7.41332 7.48003L8.63332 8.44003C8.92666 8.66669 9.34666 8.61336 9.57332 8.32669L11.1133 6.34003" stroke="#DC1FFF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
    );
}
